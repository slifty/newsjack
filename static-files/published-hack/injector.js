...
var topBarHTML = '<div class="hackpub-top-bar">' +
	...
	'<p>This page was remixed from its original news source using <a href="http://www.newsjack.in">Newsjack</a>.  <a href="http://www.newsjack.in">Create a Newsjack of your own.</a></p>' +
	'</div>' +
	'<div id="newsjack-credits">Credits: by <a href="http://slifty.com">slifty</a> and <a href="http://schock.cc">schock</a>.  NewsJack is a project of MIT\'s <a href="http://civic.mit.edu">Center for Civic Media</a></div>' + 
